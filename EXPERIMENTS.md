...
| Generalized hybrid | `codex/exp-generalized-hybrid` | **0.9400** | **0.638409** | **2.840** | **0.8160** | **0.824723** | Selected |
...
- The four official scenario groups are reported separately; the selected branch scores HitRate `1.00` Boundary, `0.9625` Browsing, `0.925` Buying, and `0.90` Intent Override.
